...
class MonoCameraAvoidance:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/uav1/front_cam/camera/image", Image, self.image_callback)
        self.imu_sub = rospy.Subscriber("/uav1/raw_imu", Imu, self.imu_callback)
    ...
    def image_callback(self, msg):
        ...
        if self.obstacle_detected or self.forward_accel > 1.0:
